                ...
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="navbarsExample09">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li>
                                <NavLink className={linkClasses} aria-current="page" to="ModelMetadatas">Модель</NavLink>
                            </li>
                            
                            <li>
                                <NavLink className={linkClasses} aria-current="page" to="ProjectMetadatas">Проект</NavLink>
                            </li>
                            
                            <li>
                                <NavLink className={linkClasses} aria-current="page" to="FormMetadatas">Форма</NavLink>
                            </li>
                            
                            <li>
                                <NavLink className={linkClasses} aria-current="page" to="PropMetadatas">Свойство</NavLink>
                            </li>
